...
\begin{itemize}
	...
	\item versi 2.2.1 (16 Desember 2024):
		...
		\end{itemize}
	\item versi 2.2.2 (8 Mei 2026):
		\begin{itemize}
			\item Perbaikan minor tutorial.
			\item Penambahan dukungan untuk simbol-simbol matematis lanjutan dengan \code{amssymb}.
			\item Fitur baru: \f{Support} untuk \code{subfigure}.
			\item \f{Bugfix}: isu pembuatan \f{glossary} secara otomatis dengan \code{makeglossaries}.
		\end{itemize}
\end{itemize}
\clearpage
